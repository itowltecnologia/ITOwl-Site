export default function CtaBanner() {
  return (
    <section className="py-20 bg-gradient-to-r from-blue-600 to-sky-600 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 text-center md:text-left">
        ...
        <div className="flex-shrink-0">
          <a href="#contato" className="inline-flex items-center justify-center bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-blue-50 transition-all hover:-translate-y-1 hover:shadow-xl shadow-white/10">
            Fale conosco agora
          </a>
        </div>
      </div>
